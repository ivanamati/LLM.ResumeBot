...
vectorstore = FAISS.load_local("vectorindex_openai", OpenAIEmbeddings(api_key=OPENAI_API_KEY),allow_dangerous_deserialization=True)

# Retrieve the information from the vectorestore
retriever = vectorstore.as_retriever(k=2)

# query = "What python libraries can Ivana use?"
